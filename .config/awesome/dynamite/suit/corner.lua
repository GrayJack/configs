...
--
--@DOC_dynamite_suit_corner_mwfact_EXAMPLE@
--
-- **gap effect**:
--
-- The "useless" gap tag property will change the spacing between clients.
--@DOC_dynamite_suit_corner_gap_EXAMPLE@
--
-- **resize effect:**
--@DOC_dynamite_suit_corner_resize_EXAMPLE@
--
...
--
--@DOC_dynamite_suit_corner_padding_EXAMPLE@
-- See `awful.screen.padding`
-- @clientlayout dynamite.suit.corner
...
local function ctr(t, mirror_v, mirror_h) --luacheck: no unused_args
    local mwf = t and t.master_width_factor or 0.66
