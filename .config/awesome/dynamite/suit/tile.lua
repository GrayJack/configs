...
--@DOC_dynamite_suit_tile_directions_EXAMPLE@
--
...
--@DOC_dynamite_suit_tile_scaling_EXAMPLE@
--
-- **master_count effect**:
--
...
local function ctr(t, direction)
    ...
    main_layout._private.col_layout = l_ratio[
        (direction == "left" or direction == "right")
