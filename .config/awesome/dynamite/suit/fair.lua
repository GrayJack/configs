...
--@DOC_dynamite_suit_fair_gap_EXAMPLE@
...
--
--@DOC_dynamite_suit_fair_padding_EXAMPLE@
--
-- **Resize effect**:
--
--@DOC_dynamite_suit_fair_resize_EXAMPLE@
--
-- See `awful.screen.padding`
-- @clientlayout dynamite.fair
...
local function ctr(_, direction)
    local main_layout = l_ratio[
        (direction == "left" or direction == "right")
            and "horizontal" or "vertical"
    ]()

    main_layout._col_layout = l_ratio[
        (direction == "left" or direction == "right")
...
-- @clientlayout dynamite.fair.horizontal
-- @see dynamite.fair
