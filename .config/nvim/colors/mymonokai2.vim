...
let s:pink        = { "gui": "#FF3574", "cterm": "197" }
let s:green       = { "gui": "#B2E64C", "cterm": "148" }
let s:aqua        = { "gui": "#5596F1", "cterm": "81" }
let s:yellow      = { "gui": "#E6DB7A", "cterm": "186" }
let s:orange      = { "gui": "#FAA23D", "cterm": "208" }
let s:purple      = { "gui": "#AA7DFC", "cterm": "141" }
