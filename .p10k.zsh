# Generated by Powerlevel10k configuration wizard on 2020-04-23 at 18:55 -03.
...
() {
  ...
  # If the repository is large, or the machine is slow, this computation can take quite a bit of time.
